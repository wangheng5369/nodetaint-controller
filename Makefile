...
KIND_CLUSTER ?= nodetaint-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name nodetaint-controller-builder
	$(CONTAINER_TOOL) buildx use nodetaint-controller-builder
	...
	- $(CONTAINER_TOOL) buildx rm nodetaint-controller-builder
	rm Dockerfile.cross

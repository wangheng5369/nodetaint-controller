...
import (
	...
	"github.com/wangheng5369/nodetaint-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(nodeopsv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8da51e56.node.io",
	...
	if err := (&controller.NodeTaintRuleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "nodetaintrule")
		os.Exit(1)
	}
